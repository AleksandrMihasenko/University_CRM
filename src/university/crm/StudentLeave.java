...
public class StudentLeave extends JFrame implements ActionListener {
    ...
    StudentLeave() {
        ...
        Jlabel headerLabel = new JLabel("Apply leave (Student)");
        headerLabel.setBounds(40, 50, 300, 30);
        headerLabel.setFont(new Font("Tahoma", Font.BOLD, 20));
        add(headerLabel);

        JLabel studentRoll = new JLabel("Search by Roll Number");
        studentRoll.setBounds(60, 100, 200, 20);
        studentRoll.setFont(new Font("Tahoma", Font.PLAIN, 18));
        add(studentRoll);
